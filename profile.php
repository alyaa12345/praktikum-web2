...
<div class="row">
    <div class="col-md-12">
        <div class="text-center">
            <img src="img/alya...jpg" alt="alya" width="160" class="rounded-circle">
            <table class="table mt-4" style="width:100%; margin:0 auto;">
                <tbody>
                    <tr>
                        <td align="right" width="50%"><strong>NIK / NPM :</strong></td>
                        <td align="left" width="50%">6304046610040002 / 2210010455</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" width="50%">Alya Normaida</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Tempat, Tanggal Lahir :</strong></td>
                        <td align="left" width="50%">Anjir muara, 26 oktober 2004</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Telepon :</strong></td>
                        <td align="left" width="50%">085727263496</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>email :</strong></td>
                        <td align="left" width="50%">alyanormaida123@gmail.com</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Media Sosial :</strong></td>
                        <td align="left" width="50%">
                            <a href="https://www.instagram.com/alyanrmda_" target="_blank" style="text-decoration:none;">
